...
define(function(require){
    ...
    function Polygon(radius, sides, color, alpha, lineWidth){
        this.radius = void 0 === radius ? 150 : radius;
    ...
    var cc = (function(me){
        ...
        var height = '1000px';
        var helfWidth = ($(window).width()- 10) / 2;
        var helfHeight = ($(window).height() -10) / 2;
        // 比例
        var ratio = 1;
        // 边书
        var sideNum = 8;
        var wrapper = $("#wrapper").css({width:width1,height:height1});
        ...
        function createParticle(t) {
            ...
            for (var polygon, n = 0; t > n; n++) {
                ...
                g(polygon);
                n % sideNum === ~~(10 * Math.random()) && (polygon.radius += 10 + 20 * Math.random());
    ...
    function changeDesignOnScroll(changeScrollValue) {
        ...
        if (changeScrollValue > startScrollValue) {
          ...
          if(marginTop<4) {
            ...
            var mt= marginTop+ "em";
            console.log(marginTop + " : "+ mt);
            $(".home canvas").css("margin-top", mt);
          }
        ...
        // scroll up
        if (changeScrollValue < startScrollValue) {
          if(changeScrollValue==0) {
            marginTop=0;
            $(".home canvas").css("margin-top", marginTop);
          }
          ...
          if(marginTop>0) {
            marginTop= marginTop- 0.5;
            var mu= marginTop+ "em";
            console.log("Decreasing "+marginTop + " : "+ mu);
            $(".home canvas").css("margin-top", mu);
          }
          startScrollValue = changeScrollValue;
        }
      }
